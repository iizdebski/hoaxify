...
describe('apiCalls', () => {
    ...
    describe('signup', () => {
        ...
        it('calls /api/1.0/users?page=5&size=10 when corresponding param provided for listUsers', () => {
            const mockListUsers = jest.fn();
            axios.get = mockListUsers;
        ...
        it('calls /api/1.0/users?page=0&size=5 when only page param provided for listUsers', () => {
            const mockListUsers = jest.fn();
            axios.get = mockListUsers;
